describe 'asset', ->
  ...
  it 'make sure the asset service descriptor validates', -> 
    ...
    service = JSON.parse(fs.readFileSync "./v1/spidamin/asset/interfaces/asset.json")
  ...
  it 'make sure the geo coder service descriptor validates', ->  
    ...
    service = JSON.parse(fs.readFileSync "./v1/spidamin/asset/interfaces/asset_search.json")
    for method of service
      if method!="id" and method!="description" 
        testUtils.validate(service[method], "./v1/general/service_method.schema", true)
  ...
  it 'make sure the geo coder service descriptor validates', ->  
    logger.debug("make sure the geo coder service descriptor validates") 
    service = JSON.parse(fs.readFileSync "./v1/spidamin/geo/interfaces/geo_coder.json")
    for method of service
      if method!="id" and method!="description" 
        testUtils.validate(service[method], "./v1/general/service_method.schema", true)
  ...
  it 'make sure the user service descriptor validates', ->  
    ...
    service = JSON.parse(fs.readFileSync "./v1/spidamin/user/interfaces/users.json")
    for method of service
      if method!="id" and method!="description" 
        testUtils.validate(service[method], "./v1/general/service_method.schema", true)  
  ...
  it 'make sure the users security service descriptor validates', ->  
    ...
    service = JSON.parse(fs.readFileSync "./v1/spidamin/user/interfaces/users_security.json")
    for method of service
      if method!="id" and method!="description" 
        testUtils.validate(service[method], "./v1/general/service_method.schema", true)
  ...
  it 'make sure the wire analysis descriptor validates', ->  
    ...
    service = JSON.parse(fs.readFileSync "./v1/spidacalc/interfaces/wire_analysis.json")
    for method of service
      if method!="id" and method!="description" 
        testUtils.validate(service[method], "./v1/general/service_method.schema", true)
  ...
  it 'make sure the client data descriptor validates', ->  
    ...
    service = JSON.parse(fs.readFileSync "./v1/spidacalc/interfaces/client_data.json")
    for method of service
      if method!="id" and method!="description" 
        testUtils.validate(service[method], "./v1/general/service_method.schema", true)
