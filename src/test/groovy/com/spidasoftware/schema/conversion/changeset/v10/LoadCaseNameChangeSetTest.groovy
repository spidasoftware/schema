...
class LoadCaseNameChangeSetTest extends Specification {
    ...
    def "apply/revert client data"() {
        ...
        expect:
            ...
            json.analysisCases[15].type == "NESC Extreme Wind 2012"
            json.analysisCases[16].type == "NESC Extreme Ice 2012"
            json.analysisCases[17].type == "CSA 2015"
        ...
        then: "types get updated"
            ...
            json.analysisCases[15].type == "NESC Extreme Wind 2012-2017"
            json.analysisCases[16].type == "NESC Extreme Ice 2012-2017"
            json.analysisCases[17].type == "CSA 2015-2020"
    ...
    def "apply/revert project json"() {
        ...
        expect:
            ...
            json.defaultLoadCases[12].type == "NESC Extreme Wind 2012"
            json.defaultLoadCases[13].type == "NESC Extreme Ice 2012"
            json.defaultLoadCases[14].type == "CSA 2015"
        ...
        then:
            ...
            json.defaultLoadCases[12].type == "NESC Extreme Wind 2012-2017"
            json.defaultLoadCases[13].type == "NESC Extreme Ice 2012-2017"
            json.defaultLoadCases[14].type == "CSA 2015-2020"
