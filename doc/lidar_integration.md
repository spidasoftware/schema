...
| Terrain under spans | `wireEndPoints[].terrainPoints` (per span), or project `terrainLayers` + `appliedTerrainLayers` (one lat/lon/elevation ground surface applied to a design layer) | For clearance analysis |
