...
- **Project JSON and Detailed Results**  This is essentially the same as above, except that all the results for the project must be sent with the request. Each result should be added to the request as its own parameter, and the 'name' of the parameter must match the results id given in the 'uri' property of the analysis array. For example, given the result: `{"uri":"588a58e17d84ad3bd41c4562"}`, the request would need to have a parameter with its name as "588a58e17d84ad3bd41c4562".
